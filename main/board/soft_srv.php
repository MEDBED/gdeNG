...
<div id="container2">	
	<div class="content">
            ...
            $requete="SELECT a.*,a.nom as nom_logiciel,b.nom as nom_poste,c.detail as modele, d.detail as marque FROM soft a,modele c, marque d, materiel b WHERE a.id_materiel=b.id AND b.id_entite=:id_entite AND b.id_modele=c.id AND c.id_marque=d.id AND a.alerte_adm>0 AND a.alerte_adm<5 AND b.id_zone NOT IN (1,2) ORDER BY a.alerte_adm DESC;";
