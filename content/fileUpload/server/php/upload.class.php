...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true) {
        $this->options = array(
            ...
            'database' => $GLOBALS['params']['bdd']['db_name'],
            'host' => $GLOBALS['params']['bdd']['db_host'],
            'username' => $GLOBALS['params']['bdd']['db_user'],
            'password' => $GLOBALS['params']['bdd']['db_pass'],
            // end
            'script_url' => $this->get_full_url().'/',
            //'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/files/',
            'upload_dir' => $GLOBALS['params']['appli']['document_folder'].'/files/',
    ...
    {
        $add_to_db = $this->query("INSERT INTO document (file,updateOn,createOn) VALUES ('".$whichimg."',now(),now())") or die(mysql_error());
        return $add_to_db;
    } 
