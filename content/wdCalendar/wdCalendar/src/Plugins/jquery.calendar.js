...
/*                    ss.push(dateFormat.call(data[2], i18n.xgcalendar.dateformat.Md3), " (", __WDAY[data[2].getDay()], ")");*/
                    //ss.push(dateFormat.call(data[2], i18n.xgcalendar.dateformat.Md3), " (", __WDAY[data[2].getDay()], ")");
                    ss.push( __WDAY[data[2].getDay()], " ",dateFormat.call(data[2],i18n.xgcalendar.dateformat.Md3));
                    if (data[4] != 1) {
                        ss.push(" à ", dateFormat.call(data[2], "HH:mm"));
                    }

                    if (iscos) {
                        ss.push(" au ", __WDAY[data[3].getDay()], " ", dateFormat.call(data[3], i18n.xgcalendar.dateformat.Md3));
                        if (data[4] != 1) {
                            ss.push(" à ", dateFormat.call(data[3], "HH:mm"));
                        }
                    }
