...
try
{
	...
	{
		//Get record count
		$result = mysql_query("SELECT COUNT(*) AS RecordCount FROM materiel;");
		$row = mysql_fetch_array($result);
		$recordCount = $row['RecordCount'];

		//Get records from database
		$result = mysql_query("SELECT * FROM materiel ORDER BY " . $_GET["jtSorting"] . " LIMIT " . $_GET["jtStartIndex"] . "," . $_GET["jtPageSize"] . ";");
